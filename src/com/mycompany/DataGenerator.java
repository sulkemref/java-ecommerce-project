...
public class DataGenerator {
    ...
    public static void createCustomer(){
        ...
        List<Address> costumer1AddressList = new ArrayList<>();
        costumer1AddressList.add(address1Customer1);
        costumer1AddressList.add(address2Customer1);

        Customer customer1 = new Customer(UUID.randomUUID(),"ozzy","ozzy@cydeo.com",costumer1AddressList);
